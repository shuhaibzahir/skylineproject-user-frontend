...
const Register = () => {
  ...
  const checkUserName = (e) => {
    let validation = validator.isAlpha(e.target.value, "en-US", {
      ignore: " ",
    });
    if (validation) {
  ...
  const signupApiCalling = () => {
    ...
    if (signUpData.preferredLocation.length === 0) {
      ...
      !phoneNumberValidate &&
      !emailValidation &&
      signUpData.preferredLocation.length > 0
    ) {
  ...
  const onFailureWithGoogele=(res)=>{
            ...
            <div className="relative flex justify-center">
              <div className=" flex items-center w-1/2   relative flex-col justify-center  space-y-5 h-screen p-6">
                <h1 className="text-2xl">
                  {" "}
                  Sign In to{" "}
                  <span className="text-pink capitalize font-bold">
                    skyline
                  </span>{" "}
                </h1>
                <div
                  className={`w-1/2 rounded-full ${progress ? "" : "hidden"}`}
                >
                  <LinearProgress />
                </div>
                ...
                <div className="w-full px-7  flex items-center justify-between">
                  ...
                  <p className="  ml-4">
                    ...
                    <AiOutlineLogin
                      ...
                      className="inline ml-4 text-dark-gray hover:text-pink cursor-pointer"
                      size="1.6rem "
                    />
                  </p>
                </div>
                ...
                <div>
                  <GoogleLogin
                    clientId="758095114048-3f9nic38mdvfolj12rmva0ce2g9hi15v.apps.googleusercontent.com"
                    buttonText="Sign Or Sign UP with Google"
                    onSuccess={onSuccessWithGoogle}
                    onFailure={onFailureWithGoogele}
